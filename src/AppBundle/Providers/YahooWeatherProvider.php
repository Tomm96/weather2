...
use AppBundle\WeatherProviderException;
...
class YahooWeatherProvider implements WeatherProviderInterface
{
    ...
    public function fetch(Location $location): Weather
    {
        ...
        if ($obj == "") {
            throw new WeatherProviderException("Can't get weather from Yahoo Provider. It seems that API doesn't work.", 5);
        } elseif ($temp == "") {
            throw new WeatherProviderException("Can't get weather from Yahoo Provider. It seems that you typed unknown City name.", 5);
        }
